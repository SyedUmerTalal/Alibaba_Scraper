...
$data = [];
    ...
    $html = file_get_html('https://www.alibaba.com/catalog/textile-processing_cid280504?page=1&Country=PK&param_order=CNTRY-PK?v=' . rand());
    clearstatcache();
    if ($html->find('.organic-gallery-offer__seller-company', 0)) {
        foreach ($html->find('.organic-gallery-offer__seller-company') as $element) :
